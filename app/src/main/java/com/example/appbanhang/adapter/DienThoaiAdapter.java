...
public class DienThoaiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            myViewHolder.setItemClickListener(new ItemClickListener() {
                ...
                public void onClick(View view, int pos, boolean isLongClick) {
                   if(!isLongClick){
                       ...
                       EventBus.getDefault().postSticky(new DeleteEvent(sanPham));
                   }
                }
            });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener, View.OnLongClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp=(TextView) itemView.findViewById(R.id.itemdt_ten);
            giasp=(TextView) itemView.findViewById(R.id.itemdt_gia);
            mota=(TextView) itemView.findViewById(R.id.itemdt_mota);
           // idsp=(TextView) itemView.findViewById(R.id.itemdt_idsp);
            hinhanh=(ImageView) itemView.findViewById(R.id.itemdt_image);
